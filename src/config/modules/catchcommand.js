...
module.exports = async (msg) => {
  ...
  new DiscordEmbed()
    ...
    .setAuthor(`${msg.sender.verifiedName || msg.sender.shortName || msg.sender.formattedName || msg.sender.name} | ${msg.sender.id.replace('@c.us', '')}`, msg.sender.profilePicThumbObj.eurl)
