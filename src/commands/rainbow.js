...
module.exports = class CanvasCommand extends Commands {
  ...
  async execute({ msg, args }) {
    try {
      ...
      msg.send(`Algo deu errado, talvez você não tem foto ou ela esta privada. Se não é nenhum dos dois, peça para alguem fazer pra você, se o erro ainda insistir, contate o +5511951746304, Infelizmente a API do whatsapp é um lixo e as vezes recusa de mim pegar a foto de alguns... :(\n\n\n${error}`)
    }
  }
}